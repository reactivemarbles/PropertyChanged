...
{
    internal sealed record ExpressionArgument(string LambdaBodyString, List<ExpressionChain> ExpressionChain, ITypeSymbol InputType, ITypeSymbol OutputType, bool ContainsPrivateOrProtectedMember)
    {
