...
{
    internal class OneWayBindExtractor : IExtractor
    {
        ...
        {
            foreach (var invocationInfo in syntaxReceiver.BindOneWay.SelectMany(invocationExpression => GenerateInvocation(context, compilation, invocationExpression, true)))
            {
