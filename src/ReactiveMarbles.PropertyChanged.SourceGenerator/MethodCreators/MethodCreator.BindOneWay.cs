...
namespace ReactiveMarbles.PropertyChanged.SourceGenerator.MethodCreators
{
    ...
    {
        private static List<StatementSyntax> CreateOneWayBindStatements(ExpressionArgument hostExpressionArgument, ExpressionArgument targetExpressionArgument, bool hasConverters, bool isExtension, List<ExpressionChain> hostExpressionChains, List<ExpressionChain> targetExpressionChains)
        {
            ...
            var observableChain = GetObservableChain(fromName, hostExpressionChains, Constants.WhenChangedEventName, Constants.WhenChangedEventHandler);
            ...
            List<StatementSyntax> statements)
        {
            ...
            var body = Block(statements, isExtension ? 2 : 3);

            return MethodDeclaration(modifiers, Constants.SystemDisposableTypeName, Constants.BindOneWayMethodName, parameterList, 0, body);
        }
    }
}
