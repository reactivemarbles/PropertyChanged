...
namespace ReactiveMarbles.PropertyChanged.SourceGenerator
{
    ...
    internal static class SyntaxFactoryHelpers
    {
        ...
        public static AccessorListSyntax AccessorList(IReadOnlyList<AccessorDeclarationSyntax> accessors) =>
            SyntaxFactory.AccessorList(Token(SyntaxKind.OpenBraceToken).AddTrialingSpaces().AddLeadingSpaces(), List(GetSpacedAccessors(accessors)), Token(SyntaxKind.CloseBraceToken).AddLeadingSpaces());
